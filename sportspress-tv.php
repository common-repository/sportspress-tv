<?php
/**
 * @package Legacy_ePlayer
 * @version 0.9.9
 */
/*
Plugin Name: Legacy ePlayer
Plugin URI: https://wordpress.org/plugins/sportspress-tv/
Description: The streaming service is no longer available, so this plugin will not be able to stream any videos.
Author: brianmiyaji
Version: 0.9.9
Author URI: https://github.com/brianmiyaji
*/
if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly
}

if ( ! class_exists( 'Legacy_ePlayer' ) ) :

/**
 * Main Legacy_ePlayer Class
 *
 * @class Legacy_ePlayer
 * @version	0.9.9
 */
class Legacy_ePlayer {
	...
	/**
	 * @var Legacy_ePlayer The single instance of the class
	 * @since 0.9
	 */
	...
	/**
	 * Main Legacy_ePlayer Instance
	 *
	 * Ensures only one instance of Legacy_ePlayer is loaded or can be loaded.
	 *
	 * @since 0.9
	 * @static
	 * @see Legacy_ePlayer()
	 * @return Legacy_ePlayer - Main instance
	 */
	...
	*/
	...
	/**
	 * Output the Legacy ePlayer shortcode.
	 *
	 * @param array $atts
	 */
	...
	public function ajax() {
		...
		<div class="wrap sportspress-tv-thickbox-content" id="sportspress-tv-thickbox">
			<form>
				...
				<p class="submit">
					<input type="button" class="button-primary" value="<?php _e( 'Insert Legacy ePlayer', 'sportspress-tv' ); ?>" onclick="insert_sportspress_tv();" />
	...
	public function admin_menu() {
		add_options_page( __( 'Legacy ePlayer Settings', 'sportspress-tv' ), __( 'Legacy ePlayer', 'sportspress-tv' ), 'manage_options', 'sportspress-tv', array( $this, 'settings_page' ) );
	}
	...
	public function settings_page() {
		...
		<div class="wrap sportspress-tv">
			<h2><?php _e( 'Legacy ePlayer Settings', 'sportspress-tv' ); ?></h2>
...
return Legacy_ePlayer::instance();
