<?php
/**
 * Legacy ePlayer Widget class.
 *
 * @class 		Legacy_ePlayer_Widget
 * @version     0.9
 * @package 	Legacy_ePlayer/Classes
 * @author 		brianmiyaji
 * @category 	Widgets
 */
class Legacy_ePlayer_Widget extends WP_Widget {

	function __construct() {
		$widget_ops = array( 'classname' => 'widget_sportspress_tv', 'description' => __( 'Legacy ePlayer widget.', 'sportspress_tv' ) );
		parent::__construct( 'sportspress_tv', __( 'Legacy ePlayer', 'sportspress-tv' ), $widget_ops );
	}

	function widget( $args, $instance ) {
		$sportspress_tv = Legacy_ePlayer::instance();
...
register_widget( 'Legacy_ePlayer_Widget' );
